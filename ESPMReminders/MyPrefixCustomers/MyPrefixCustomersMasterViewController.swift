//
// MyPrefixCustomersMasterViewController.swift
// ESPMReminders
//
...
class MyPrefixCustomersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator, TableUpdaterDelegate {
    ...
    private let logger = Logger.shared(named: "MyPrefixCustomerMasterViewConterollerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! MyPrefixCustomersDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! MyPrefixCustomersDetailViewController
