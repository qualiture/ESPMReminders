...
open class MyPrefixPurchaseOrderItem: EntityValue {
    ...
    public static var currencyCode: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "CurrencyCode")

    public static var grossAmount: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "GrossAmount")

    public static var netAmount: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "NetAmount")

    public static var productID: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "ProductId")

    public static var itemNumber: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "ItemNumber")

    public static var purchaseOrderID: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "PurchaseOrderId")

    public static var quantity: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "Quantity")

    public static var quantityUnit: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "QuantityUnit")

    public static var taxAmount: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "TaxAmount")

    public static var productDetails: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "ProductDetails")

    public static var header: Property = MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem.property(withName: "Header")

    public init(withDefaults: Bool = true) {
        super.init(withDefaults: withDefaults, type: MyPrefixMyServiceClassMetadata.EntityTypes.purchaseOrderItem)
    }
