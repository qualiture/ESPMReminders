...
open class MyPrefixProduct: EntityValue {
    ...
    public static var category: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "Category")

    public static var categoryName: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "CategoryName")

    public static var currencyCode: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "CurrencyCode")

    public static var dimensionDepth: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "DimensionDepth")

    public static var dimensionHeight: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "DimensionHeight")

    public static var dimensionUnit: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "DimensionUnit")

    public static var dimensionWidth: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "DimensionWidth")

    public static var longDescription: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "LongDescription")

    public static var name: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "Name")

    public static var pictureUrl: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "PictureUrl")

    public static var price: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "Price")

    public static var productID: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "ProductId")

    public static var quantityUnit: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "QuantityUnit")

    public static var shortDescription: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "ShortDescription")

    public static var supplierID: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "SupplierId")

    public static var updatedTimestamp: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "UpdatedTimestamp")

    public static var weight: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "Weight")

    public static var weightUnit: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "WeightUnit")

    public static var stockDetails: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "StockDetails")

    public static var supplierDetails: Property = MyPrefixMyServiceClassMetadata.EntityTypes.product.property(withName: "SupplierDetails")

    public init(withDefaults: Bool = true) {
        super.init(withDefaults: withDefaults, type: MyPrefixMyServiceClassMetadata.EntityTypes.product)
    }
