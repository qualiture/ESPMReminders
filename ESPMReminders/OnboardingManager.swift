...
class OnboardingManager {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "com.sap.tutorials.demoapp.ESPMReminders", authenticationPath: "com.sap.tutorials.demoapp.ESPMReminders")
        ...
        welcomeScreen.welcomeScreenCustomizationHandler = { welcomeScreen in
            welcomeScreen.headlineLabel.text = "ESPMReminders"
