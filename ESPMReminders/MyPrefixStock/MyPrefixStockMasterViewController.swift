//
// MyPrefixStockMasterViewController.swift
// ESPMReminders
//
...
class MyPrefixStockMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator, TableUpdaterDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! MyPrefixStockDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! MyPrefixStockDetailViewController
